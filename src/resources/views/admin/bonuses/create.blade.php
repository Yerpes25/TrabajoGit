                ...
                <div class="p-6">
                    <form action="{{ route('admin.bonuses.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 rounded-md" rows="3">{{ old('description') }}</textarea>
                            <x-input-error :messages="$errors->get('description')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="seconds_total" value="Tiempo (segundos)" />
                            <x-text-input id="seconds_total" name="seconds_total" type="number" min="1" class="mt-1 block w-full" :value="old('seconds_total')" required />
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>Crear Bono</x-primary-button>
