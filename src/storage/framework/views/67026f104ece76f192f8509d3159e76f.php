...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Panel de Cliente')); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">
                            <?php echo e(number_format($balanceSeconds / 3600, 2)); ?> horas
                        </p>
                        <p class="text-xs text-gray-500 mt-1"><?php echo e(gmdate('H:i:s', $balanceSeconds)); ?></p>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <a href="<?php echo e(route('client.work-reports.index')); ?>" class="text-blue-500">Ver Todos</a>
                        </div>
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        <?php $__currentLoopData = $recentWorkReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="px-4 py-2">
                                                    <a href="<?php echo e(route('client.work-reports.show', $report)); ?>" class="text-blue-500">Ver</a>
                                                </td>
                                            </tr>
